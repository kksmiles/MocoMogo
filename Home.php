          ...
          <div class="row">
            ...
            <div class="row">
              <div class="col-xl-3 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                    <button type="button" class="multiplierButtons btn btn-outline-secondary" style="border-color: #3f3f3f;" onclick="x2multiplier()"  id="btns2">2x</button>
                    <div style="color: #3f3f3f; text-align: center; height: 150px; overflow: hidden;" id="2xbetlog"></div>
              </div>
              <div class="col-xl-3 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                    <button type="button" class="multiplierButtons btn btn-outline-danger" style="border-color: #c8354e;" onclick="x3multiplier()"  id="btns3">3x</button>
                    <div style="color: #c8354e; text-align: center; height: 150px; overflow: hidden;" id="3xbetlog"></div>
              </div>
              <div class="col-xl-3 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                  <button type="button" class="multiplierButtons btn btn-outline-primary" style="border-color: #45b5da;" onclick="x5multiplier()" id="btns5">5x</button>
                  <div style="color: #45b5da; text-align: center; height: 150px; overflow: hidden;" id="5xbetlog"></div>
              </div>
              <div class="col-xl-3 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                  <button type="button" class="multiplierButtons btn btn-outline-warning" style="border-color: #ffc870;" onclick="x20multiplier()" id="btns20">20x</button>
        ...
        <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12" style="background-color: #1d1c22; height: 700px;">
          <div>
              ...
              <div class="card text-white mb-3" style="background-color: #1d1c22; height: 500px;"  >
                <span style="text-align: center; margin-top: 20px; color: #fec61a; font-size: 1.3rem;">ROULETTE CHATBOX</span>
