          ...
          <div id="betlog" style="display: none;"></div>
            <div class="row">
              <div class="col-xl-2 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                    <button type="button" class="multiplierButtons btn btn-outline-danger" style="border-color: #c8354e;" onclick="btn1()" id="btn23">2-3 (3x)</button>
              ...
              <div class="col-xl-3 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                    <button type="button" class="multiplierButtons btn btn-outline-danger" style="border-color: #c8354e;" onclick="btn2()" id="btn45">4-5 (3x) </button>
                    <div style="color: #c8354e; text-align: center; height: 150px; overflow: hidden;" id="45betlog"></div>
              </div>
              <div class="col-xl-2 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                  <button type="button" class="multiplierButtons btn btn-outline-primary" style="border-color: #45b5da;" onclick="btn3()" id="btn68">6-8 (2x) </button>
                  <div style="color: #45b5da; text-align: center; height: 150px; overflow: hidden;" id="68betlog"></div>
              </div>
              <div class="col-xl-3 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                  <button type="button" class="multiplierButtons btn btn-outline-primary" style="border-color: #45b5da;" onclick="btn4()" id="btn911">9-11 (2x)</button>
                  <div style="color: #45b5da; text-align: center; height: 150px; overflow: hidden;" id="911betlog"></div>
              </div>
              <div class="col-xl-2 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                  <button type="button" class="multiplierButtons btn btn-outline-warning" style="border-color: #ffc870;" onclick="btn5()" id="btn12">12 (5x)</button>
...
<div class="card text-white mb-3" style="background-color: #1d1c22; height: 500px;"  >
                <span style="text-align: center; margin-top: 20px; color: #fec61a; font-size: 1.3rem;">DICE CHATBOX</span>
